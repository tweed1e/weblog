...
So, once we create language dummy variables to try to control for episode characteristics that may affect ratings, we find ourselves with too many predictors. There are only `r nrow(titles)` episodes but we create way more language dummies `r emo::ji('surprise')`.
