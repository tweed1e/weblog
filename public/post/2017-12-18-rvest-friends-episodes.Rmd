...
I bet if I write an episode titled "The One Where Rachel [does X]" is an automatic classic. Let's check. First, use `tidytext::unnest_tokens` to split the titles into words, and then take out common filler words ('The', 'One', 'a', etc.) with the quick and helpful `anti_join(stop_words)`.
